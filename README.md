...
<div style="display: flex; flex-direction: row; align-items: flex-start; margin-top: 20px;">
  ...
  <div style="flex-basis: 50%; display: flex; flex-direction: column; gap: 10px;">
    ...
    <img width="300" height="150" alt="Schermata creazione ticket 2" src="https://github.com/user-attachments/assets/39f266ac-a894-43d7-ab3f-6566e3fce3fc" style="max-width: 100%; height: auto;"/>
